...
(function ($, undefined) {
    ...
    $.widget("ui.mouse", {
        ...
        _mouseDown: function (event) {
            ...
            var that = this,
                btnIsLeft = (event.which === 1), // event.target.nodeName works around a bug in IE 8 with
    ...
    $.extend(Datepicker.prototype, {
        ...
        parseDate: function (format, value, settings) {
            ...
            var iFormat, dim, extra, iValue = 0,
                ...
                doy = -1,
                literal = false,
                date, // Check whether a format character is doubled
        ...
        formatDate: function (format, date, settings) {
            ...
            var iFormat, dayNamesShort = (settings ? settings.dayNamesShort : null) || this._defaults.dayNamesShort,
                dayNames = (settings ? settings.dayNames : null) || this._defaults.dayNames,
                monthNamesShort = (settings ? settings.monthNamesShort : null) || this._defaults.monthNamesShort,
                monthNames = (settings ? settings.monthNames : null) || this._defaults.monthNames, // Check whether a format character is doubled
                lookAhead = function (match) {
                    var matches = (iFormat + 1 < format.length && format.charAt(iFormat + 1) === match);
                    if (matches) {
                        iFormat++;
...
(function ($, undefined) {
    ...
    $.widget("ui.dialog", {
        ...
        _makeResizable: function () {
            var that = this,
                options = this.options,
                handles = options.resizable, // .ui-resizable has position: relative defined in the stylesheet
